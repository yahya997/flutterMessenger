...
import 'package:fluttermessengerapp/widgets/chat_input_widget.dart';
import 'package:fluttermessengerapp/widgets/chat_widget.dart';
...
//            duration: Duration(milliseconds: 100), curve: Curves.easeIn);
  ...
  void initUser() async {
    currentUser = await UserDatabase.getUser();
    if (mounted) {
      setState(() => 0);
    }
  }
...
//        ),
              ...
              children: <Widget>[
                ...
                ChatInputWidget(
                  onSubmitted: (val) {
                    ...
                    ChatsDatabase.sendMessage(chat);
  ...
  Widget buildChats() {
    return StreamBuilder(
        stream: ChatsDatabase.listenChat(currentUser, widget.friend),
